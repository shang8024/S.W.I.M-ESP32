...
#define Disallowed_State 0 // 0 if want to ignore the missed pulse, 2 if want to debug
...
void loop()
{
  ...
  //TODO
  // int posScalingFactor=2;
  
  // //Need a mapping from the mean value of real/img /up/down, to column/degrees. Use posScalingFactor for that
  // //
  // //Compute an average of the changes, scaled by a factor. This factor will need to be adjusted so that one full rotation
  // // of the motor equates to the entire array being looped through once.
